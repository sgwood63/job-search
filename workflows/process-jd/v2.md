---
name: process-jd
description: Core JD processing module — screen, create folder, compose files, save, register in tracker, capture OB1 thoughts
---
...
**Changes from v1:**
- `notes.md` stub replaced by `notes-index.md` (lightweight header + OB1 thought key registry)
- New Step 5 (OB1 only): capture `jd_analysis` and `fit_assessment` thoughts; update notes-index.md with thought IDs
- Callers are responsible for generating the full `notes.md` view — see skill `application-summary`
