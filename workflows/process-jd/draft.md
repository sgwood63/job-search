---
name: process-jd
description: Core JD processing module — screen, create folder, compose files, save, register in tracker, store structured metadata. v2 adds domain_tags and jd_requirements extraction (Phase 3).
---

# process-jd Workflow (DRAFT — v2)
