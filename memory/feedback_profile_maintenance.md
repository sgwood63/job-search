...
- [ ] **B4.5. PROFILES-QUICK-REFERENCE.md search queries** — Add a row to the `## Search Queries` table for the new profile: one OR-query combining 3–5 role/title terms. Role and title terms only — no domain expertise appended. Format: `| <profile-slug> | \`"Term A" OR "Term B" OR "Term C"\` |`
