...
**Changes from v2:**
- Consolidate to single MCP server — `mcp__open_brain__*` retired; `mcp__job_search__*` now owns all operations including thought capture and search.
