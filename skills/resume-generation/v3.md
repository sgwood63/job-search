...
description: Generate a tailored, factual resume from profile content for a screened JD, with verification gate and evaluation report. v3 adds Phase 2 semantic content retrieval (per-requirement chunk queries, OB1 mode) and Phase 3 cross-app domain patterns via find_similar_applications.
---
...
**Phase 0.5 — Content retrieval (before drafting, after Phase 0):**
